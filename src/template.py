...
class Template:
    ...
    def _parse_template_file_to_dict(self: Template, template_fpath: str) -> Dict[str, Any]:
        pass
    ...
    def create_callable_from_entry(self: Template, clickable_field: Dict[str, Any]) -> Callable:
